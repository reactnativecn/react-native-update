...
const config = {
  ...
  apps: {
    ...
    'ios.release': {
      ...
      build: `export RCT_NO_LAUNCH_PACKAGER=true && ${iosBuildBase} -configuration Release ARCHS=${iosSimulatorArch} ONLY_ACTIVE_ARCH=YES -quiet`,
    },
    'android.debug': {
      type: 'android.apk',
      binaryPath: 'android/app/build/outputs/apk/debug/app-debug.apk',
      build: `cd android && ./gradlew assembleDebug assembleAndroidTest -DtestBuildType=debug${androidArchitectures}`,
    ...
    'android.release': {
      ...
      build: `cd android && ./gradlew assembleRelease assembleAndroidTest -DtestBuildType=release${androidArchitectures}`,
    },
  },
  devices: {
    simulator: {
